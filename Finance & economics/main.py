...
def export_finance_and_economics():
    finance_and_economics_url = "https://www.economist.com/finance-and-economics"
    response = requests.get(url=finance_and_economics_url, headers=headers)
    data = response.text
    ...
    for i in range(len(articles_links)):
        ...
        with open('Finance & economics.csv', 'a', newline='', encoding="UTF-8") as file:
